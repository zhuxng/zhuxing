...
class NewCarViewController: RootViewController, UITableViewDelegate, UITableViewDataSource {
    var NewCarArray = [homeCarModel]()
        ...
        Alamofire.request(.GET, "http://mrobot.pcauto.com.cn/v2/cms/channels/1?pageNo=\(page)&pageSize=20&serialIds=2143,3404&v=4.0.0").responseJSON { (resp) in
            ...
            if let dict = resp.result.value {
                ...
                for sub in DATAArray {
                    ...
                    if sub.valueForKey("channelId") as! Int == 2 {
                        self.NewCarArray.append(model)
    ...
    func createNav() {
        ...
        addLeftTarget(#selector(NewCarViewController.backButtonClicked))
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        WebDetailVC.model = NewCarArray[indexPath.row]
